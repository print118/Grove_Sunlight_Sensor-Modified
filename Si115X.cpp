...
bool Si115X::Begin(void){
    ...
    Si115X::param_set(Si115X::CHAN_LIST, 0B00000001);
    ...
    conf[0] = 0B00001011; // ADCCONFIG_0
    conf[1] = 0B00000010, // ADCSENS_0
    conf[2] = 0B01000000; // ADCPOST_0
    conf[3] = 0B00000001; // MEASCONFIG_0
    Si115X::config_channel(1, conf);
    Serial.println("set");

    /*conf[0] = 0B00000000; // ADCCONFIG_0
    conf[1] = 0B00000010, // ADCSENS_0
    conf[2] = 0B01000001; // ADCPOST_0
    conf[3] = 0B00000001; // MEASCONFIG_0
...
uint16_t Si115X::ReadHalfWord_VISIBLE(void) {
    ...
    //return get_int_from_bytes(data, 2);
